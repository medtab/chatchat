...
csv_path = os.path.join(base_path, r"C:\pycharm\PyCharm Community Edition 2024.2.4\bin\conda\pythonProject1\CHATBOT01DEC.csv")
logo_path = os.path.join(base_path, r"C:\pycharm\PyCharm Community Edition 2024.2.4\bin\conda\pythonProject1\Log01DEC.png")
response_image_path = os.path.join(base_path, r"C:\pycharm\PyCharm Community Edition 2024.2.4\bin\conda\pythonProject1\IMG01DEC.jpg")
